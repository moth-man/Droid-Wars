...
public class Droid {
	...
	public Droid(String teamName, Position position) {
	...
	/*
	 * Take Damage : Droid takes damage from shot, subtracting damage of
	 * firing-droid from health of shot-droid.
	 */
	...
	/*
	 * Move : Takes a droid's move and moves to the cell if the cell is empty and
	 * therefore moveable, or fires at enemy in cell of move, thus shootable.
	 */
	...
	/*
	 * Analyze Cell : Checks if cell has player or not and moves to either the
	 * 'Moveable' or 'Shootable' list of DroidMoves titled 'moves'.
	 */
	...
	public void stats() {
		System.out.println("(Team: " + this.teamName + ", Health: " + this.health + ", Damage: " + this.damage
